export class ProductService {
    UpdateProductStock(order: Order, products: Product[]) {
    ...
    CheckAndGenerateNewProductPurchaseOrder(existingProductPurchaseOrders: ProductPurchaseOrder[], products: Product[]): ProductPurchaseOrder[] {
        var newProductPurchaseOrders: ProductPurchaseOrder[] = [];
